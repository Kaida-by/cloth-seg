...
class parser(object):
    def __init__(self):
        ...
        self.image_folder = "/content/cloth-seg/train/"  # image folder path
        self.df_path = "/content/cloth-seg/train.csv"  # label csv path
        ...
        if self.continue_train:
            self.unet_checkpoint = "prev_checkpoints/itr_00023000_u2net.pth"
